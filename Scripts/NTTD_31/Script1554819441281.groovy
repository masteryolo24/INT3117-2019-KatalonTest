...
WebUI.setText(findTestObject('Object Repository/Page_ng nhp - Ti khon Google/input_sachmemvn_identifier'), 'ductranvu24')
...
WebUI.setEncryptedText(findTestObject('Object Repository/Page_ng nhp - Ti khon Google/input_Qu nhiu ln th khng thnh cng_password'), 
    'jYXYZHePGAZzlgFj/54z5Q==')

WebUI.click(findTestObject('Object Repository/Page_ng nhp - Ti khon Google/content_Tip theo'))
...
WebUI.setText(findTestObject('Object Repository/Page_Hc liu - Sch Mm/textarea_Test_message_content'), 'Test')

WebUI.click(findTestObject('Object Repository/Page_Hc liu - Sch Mm/i_Gi_fa fa-paper-plane'))

WebUI.click(findTestObject('Object Repository/Page_Hc liu - Sch Mm/div_Test_fa fa-trash-o pr-3'))
