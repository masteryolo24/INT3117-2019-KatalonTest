...
WebUI.click(findTestObject('Object Repository/Page_Hc liu - Sch Mm/i_ng xut_fa fa-3x fa-bell-o text-warning'))

WebUI.setText(findTestObject('Object Repository/Page_Hc liu - Sch Mm/textarea_trim() c 1 space u tin_message_content'), 
    'Test')
